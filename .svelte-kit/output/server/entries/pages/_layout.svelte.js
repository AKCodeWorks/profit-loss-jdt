import { g as getContext, s as setContext, c as create_ssr_component, a as compute_rest_props, b as subscribe, d as spread, e as escape_attribute_value, f as escape_object, h as add_attribute, v as validate_component, o as onDestroy, i as createEventDispatcher } from "../../chunks/ssr.js";
import "dequal";
import { i as isFunction, a as isHTMLElement, w as withGet, m as makeElement, s as styleToString, p as portalAttr, e as effect, b as executeCallbacks, c as addMeltEventListener, F as FIRST_LAST_KEYS, k as kbd, S as SELECTION_KEYS, u as useEscapeKeydown, d as isElementDisabled, f as safeOnMount, g as createElHelpers, n as noop, h as disabledAttr, o as omit, j as isBrowser, l as addEventListener, q as is_void, r as cn, t as flyAndScale } from "../../chunks/utils.js";
import { s as sleep, t as tick, c as createTypeaheadSearch, a as toWritableStores, g as generateIds, d as derivedVisible, h as handleRovingFocus, b as getNextFocusable, e as getPreviousFocusable, r as removeHighlight, f as addHighlight, u as usePopper, i as getPortalDestination, j as usePortal, o as overridable, k as removeScroll, l as createBitAttrs, m as removeUndefined, n as getOptionUpdater, p as getPositioningUpdater, q as createDispatcher, v as disabledAttrs } from "../../chunks/helpers.js";
...
function createMenuBuilder(opts) {
  ...
  const { elements: { root: separator2 } } = createSeparator({
...
const Menu_separator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let { asChild = false } = $$props;
  let { el = void 0 } = $$props;
  const { elements: { separator: separator2 }, getAttrs } = getCtx();
  $$unsubscribe_separator = subscribe(separator2, (value) => $separator = value);
...
const Navigation = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<nav class="flex items-center justify-between mt-4 border-b pb-2 border-primary/25"><div class="flex items-center gap-4" data-svelte-h="svelte-5yawrk"><img src="./favicon.png" alt="Joey Does Tech Logo" class="size-14"> <h1>Profit or Loss!</h1></div> ${validate_component(Root, "DropdownMenu.Root").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Trigger, "DropdownMenu.Trigger").$$render($$result, { class: "" }, {}, {
        default: () => {
        ...
        default: () => {
          return `${validate_component(Group, "DropdownMenu.Group").$$render($$result, {}, {}, {
            default: () => {
              ...
              })} ${validate_component(Dropdown_menu_separator, "DropdownMenu.Separator").$$render($$result, {}, {}, {})} ${validate_component(Dropdown_menu_item, "DropdownMenu.Item").$$render($$result, { href: "/config" }, {}, {
                default: () => {
